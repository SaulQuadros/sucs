...
with st.expander("ℹ️ Ajuda rápida", expanded=False):
    ...
    st.download_button("Baixar planilha-modelo (CSV)", data=_csv_buf, file_name="modelo_trb.csv", mime="text/csv", key="dl_model_trb_csv_sidebar")
    # Excel modelo
    try:
        ...
        st.download_button("Baixar planilha-modelo (Excel)", data=_xlsx_buf, file_name="modelo_trb.xlsx",
                           mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", key="dl_model_trb_xlsx_sidebar")
